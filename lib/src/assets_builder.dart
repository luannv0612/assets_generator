...
const String rFileHeader =
    '/// GENERATED BY assets_generator. DO NOT MODIFY BY HAND.\n'
    '/// See more detail on https://github.com/luannv0612/assets_generator.';
...
class AssetsBuilder extends Builder {
  ...
  _AssetsScannerOptions _getOptions() {
    final optionsFile = File("assets_generator.yaml");
